...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ✅ Ambil ujian pertama, atau buat kalau belum ada
        $exam = Exam::first() ?? Exam::create([
            'name' => 'Simulasi Kecerdasan',
            'description' => 'Tes Kecerdasan Umum dan Logika Dasar',
            'duration' => 60,
            'total_questions' => 50,
            'is_active' => true,
        ]);

        // ✅ Semua soal menggunakan exam_id dari ujian di atas

        $questions = [
            // --- No 1  ------
            [

                'exam_id' => $exam->id, // ✅ penting
